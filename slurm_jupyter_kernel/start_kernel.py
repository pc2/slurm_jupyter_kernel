...
class remoteslurmkernel:
    ...
    def __init__ (self, kernel_cmd, connection_file, slurm_parameter, loginnode, proxyjump, srun_cmd):
...
def slurm_jupyter_kernel ():
    ...
    kernel = remoteslurmkernel(args.kernel_cmd, args.connection_file, args.slurm_parameter, args.loginnode, args.proxyjump, args.srun_cmd);
    kernel.kernel_state();
